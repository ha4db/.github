# Contributing to ha4Db
We want to make contributing to this project as approachable and transparent as
possible.

## Code of Conduct
ha4Db has adopted a Code of Conduct that we expect project
participants to adhere to. Please [read the full text](https://github.com/ha4Db/.github/blob/master/CODE_OF_CONDUCT.md)
...
Before we can include your contribution in the ha4Db project, you need to 
...
## License
By contributing to ha4Db, you agree that your contributions will be licensed
